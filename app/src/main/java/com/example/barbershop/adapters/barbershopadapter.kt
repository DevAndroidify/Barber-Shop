...
class barbershopadapter(val context: Context, val productList: ArrayList<barbershopdetails>, val itemClickListener: OnItemClickListener) : RecyclerView.Adapter<barbershopadapter.ProductViewHolder>() {
